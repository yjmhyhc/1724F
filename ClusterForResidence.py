...
# gain the cluster map of residence around a certain point

# Import residence geojson statistics
# Define the raw URL
...
FastMarkerCluster([[r[23].y, r[23].x] for r in filtered_ksi.itertuples()]).add_to(fig)
